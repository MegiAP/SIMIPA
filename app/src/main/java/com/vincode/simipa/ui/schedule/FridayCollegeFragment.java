...
public class FridayCollegeFragment extends Fragment {
    private CollegeScheduleAdapter collegeScheduleAdapter;
    private RecyclerView recyclerView;

    public FridayCollegeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_friday_college, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);

        recyclerView = view.findViewById(R.id.rvCollegeFriday);
    }
    ...
    private void getCollegeData(){
        ...
        Call<CollegeScheduleResponse> call = apiInterface.getCollegeData("jumat" , "1617051103","2019/2020","Ganjil", "Teori" );
