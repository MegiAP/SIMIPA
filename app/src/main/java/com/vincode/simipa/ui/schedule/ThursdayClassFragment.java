...
public class ThursdayClassFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_thursday_class, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);

        recyclerView = view.findViewById(R.id.rvclassThursday);
    }
    ...
    private void getData(){
        ...
        Call<ClassScheduleResponse> call = apiInterface.getClassData("kamis", "Ilmu Komputer");
