...
public class DetailLectureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null){
            getSupportActionBar().setTitle("Detail Jadwal Dosen");
        }
    ...
    private void setupViewPager(ViewPager viewPager) {
        DetailLectureActivity.ViewPagerAdapter adapter = new DetailLectureActivity.ViewPagerAdapter(getSupportFragmentManager());
